...
// order
var favLocation: string[] = ["a", "p", "c", "b", "d"]
...
var Copyarray: string[] = [...favLocation];
Copyarray.sort();
...
var Copyarray1: string[] = [...favLocation];
Copyarray1.reverse();
...
var favorite_fruits: any = ['mango', 'banana', 'kiwi']
...
// user:
var user:string[]=["ali", "hassan", "ahmad", "arooj"]
...
var users:string[]=["ali", "hassan", "ahmad", "arooj"]
...
var animals = ["Dog", "parrot", "Sparrow"];
...
make_shirt(23, "size is available ");
// 37. Large Shirts: Modify the make_shirt() function so that shirts are large by default with a 
// message that reads I love TypeScript. Make a large shirt and a medium shirt with the default message, and 
...
make_shirt2();
make_shirt2("Medium");
make_shirt2("Small", "size is available now !");
...
// country. The function should print a simple sentence, such as Karachi is in Pakistan. Give the parameter
...
describe_city("usa")
describe_city("america", "karachi");

// 39. City Names: Write a function called city_country() that takes in the name of a city and its country. 
// The function should return a string formatted like this: "Lahore, Pakistan" Call your function with at least 
...
make_album("rahat fateh ali", "aroooj")
...
function albums(title: string, artist: string) {
    ...
    const album3 = {
        title: "namal",
        artist: "Arooj",
        album: ["chp1", "chp2", "chp3", "chp4"]
    }
    const album4 = {
        title: "Jannat k patty",
        artist: "Arooj",
        album: ["chp1", "chp2", "chp33", "chp4"]
    }
...
var magicians: string[] = ["Ali", "arroj", "Alina", "hassan"];
...
var magician_names: string[] = ["Ali", "arroj", "Alina", "hassan"];
...
sandwich_order(["Sandwich1", "burger"])
sandwich_order(["Simple_Sandwich", "egg", "bread"])
sandwich_order(["SANDWICH", "piza", " rice"])
